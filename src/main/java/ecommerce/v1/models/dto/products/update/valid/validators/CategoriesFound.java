package ecommerce.v1.models.dto.products.update.valid.validators;
...
import ecommerce.v1.models.dto.products.update.CategoriesDto;
import ecommerce.v1.repositories.CategoriesRepository;

import java.util.Optional;

public class CategoriesFound implements ConstraintValidator<
        ecommerce.v1.models.dto.products.update.valid.annotations.CategoriesFound,
        CategoriesDto> {
